...
#define LOG_TAG "networkinspector-jni"

#define LOG_ERROR(...) log_android(ANDROID_LOG_ERROR, __VA_ARGS__)
#define LOG_WARN(...) log_android(ANDROID_LOG_WARN, __VA_ARGS__)
#define LOG_DEBUG(...) log_android(ANDROID_LOG_DEBUG, __VA_ARGS__)
#define LOG_INFO(...) log_android(ANDROID_LOG_INFO, __VA_ARGS__)
